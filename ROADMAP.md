...
- **Session journal:** see [`docs/journal/`](docs/journal/). Latest checkpoint:
  [2026-07-29 — 13.5: the pubsub reshape, or how to add a context and an error without letting Publish block](docs/journal/2026/07/2026-07-29-m13-pubsub-reshape.md).
