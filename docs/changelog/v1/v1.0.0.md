...
([Keep a Changelog 1.1.0](https://keepachangelog.com/en/1.1.0/)). Milestones: **M2 concurrency ·
M3 resilience · M4 HTTP middleware · M5 configuration · M6 structured logging · M7 caching & data ·
M8 validation & security · M9 diagnostics & lifecycle** — the feature-complete 1.0, committing to
API stability for every exported identifier under Semantic Versioning.
