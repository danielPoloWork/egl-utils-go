...
store (`hash`, 8.2). Boundaries and inputs grow as the diagnostics surface (M9) lands; each such PR
extends the rows below rather than starting fresh._
