...
How documentation is maintained on `egl-utils-go`. Documentation is part of the
...
Public symbols are documented with `godoc / pkg.go.dev`-compatible comments. The API-docs build
